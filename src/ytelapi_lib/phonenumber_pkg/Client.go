 ...
 * @param    models_pkg.NumberType2Enum        numberType     parameter: Required
...
func (me *PHONENUMBER_IMPL) CreateBulkBuyNumbers (
   ...
   _queryBuilder = _queryBuilder + "/incomingphone/bulkbuy.json"
    ...
    parameters := map[string]interface{} {
        ...
        "NumberType" : models_pkg.NumberType2EnumToValue(numberType),
        "AreaCode" : areaCode,
        "Quantity" : quantity,
        "Leftover" : leftover,
 ...
 * @param    models_pkg.NumberTypeEnum        numberType       parameter: Optional
 * @param    *string                          friendlyName     parameter: Optional
 * @return	Returns the string response from the API call
 */
 ...
 * @param    models_pkg.Numbertype1Enum        numbertype     parameter: Required
 * @param    string                            areacode       parameter: Required
 * @param    *int64                            pagesize       parameter: Optional
 * @return	Returns the string response from the API call
 */
func (me *PHONENUMBER_IMPL) CreateAvailableNumbers (
   ...
   _queryBuilder = _queryBuilder + "/incomingphone/availablenumber.json"
    ...
    parameters := map[string]interface{} {
        ...
        "numbertype" : models_pkg.Numbertype1EnumToValue(numbertype),
        "areacode" : areacode,
        "pagesize" : pagesize,
