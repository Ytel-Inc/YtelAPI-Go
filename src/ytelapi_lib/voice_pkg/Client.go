 ...
 * @return	Returns the string response from the API call
 */
func (me *VOICE_IMPL) CreateViewCall (
 ...
 * @return	Returns the string response from the API call
 */
func (me *VOICE_IMPL) CreateViewCallDetails (
            callSid string) (string, error) {
        //the base uri for api requests
    _queryBuilder := configuration_pkg.BASEURI;
 ...
 * @param    *string                       method      parameter: Optional
 * @param    models_pkg.Status1Enum        status      parameter: Optional
 * @return	Returns the string response from the API call
 */
func (me *VOICE_IMPL) CreateInterruptCall (
   ...
   _queryBuilder = _queryBuilder + "/calls/interruptcalls.json"
    ...
    parameters := map[string]interface{} {
        ...
        "Url" : url,
        "Method" : method,
        "Status" : models_pkg.Status1EnumToValue(status),
 ...
 * @param    models_pkg.Direction1Enum        direction     parameter: Optional
...
func (me *VOICE_IMPL) CreatePlayAudio (
   ...
   _queryBuilder = _queryBuilder + "/calls/playaudios.json"
    ...
    parameters := map[string]interface{} {
        ...
        "SayText" : sayText,
        "Length" : length,
        "Direction" : models_pkg.Direction1EnumToValue(direction),
        "Mix" : mix,
